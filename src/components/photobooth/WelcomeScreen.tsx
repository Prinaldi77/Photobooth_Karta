...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] w-full max-w-4xl mx-auto px-4 text-center select-none py-6">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
          ...
          >
            ...
            <h3 className="font-black text-sm uppercase">Frame Karta 02</h3>
            <p className="text-xs font-bold text-slate-900 leading-snug">
              Foto otomatis digabung ke bingkai strip ganda khas Karang Taruna.
            </p>
          </motion.div>
